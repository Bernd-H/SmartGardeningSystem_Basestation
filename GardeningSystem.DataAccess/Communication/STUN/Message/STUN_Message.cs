...
namespace LumiSoft.Net.STUN.Message
{
    ...
    public class STUN_Message
    {
        ...
        private STUN_ErrorCode m_pErrorCode = null;
            ...
            */
            ...
            // CHANGE-REQUEST
                ...
                */
                ...
                m_pChangeRequest = new STUN_ChangeRequest((data[offset] & 4) != 0, (data[offset] & 2) != 0);
                offset++;
            }
            // SOURCE-ADDRESS
            ...
            // ERROR-CODE
                ...
                */
                ...
                m_pErrorCode = new STUN_ErrorCode(errorCode, Encoding.Default.GetString(data, offset + 4, length - 4));
                offset += length;
            }
            // UNKNOWN-ATTRIBUTES
        ...
        /// Value null means not specified.
        /// </summary>
        public STUN_ChangeRequest ChangeRequest
        {
        ...
        /// </summary>
        public STUN_ErrorCode ErrorCode
        {
